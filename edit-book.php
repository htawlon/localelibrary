                    ...
                    <div class="col-sm-6 col-sm-offset-3">
                        <form enctype="multipart/form-data" method="post" action="update_book.php">
                            ...
                            <div class="form-group">
                                ...
                                <input value="<?php echo $b['title']?>" type="text" name="title" id="title" class="form-control">

                            </div>
                            <div class="form-group">
                                <label for="author" > Book Author </label>
                                <input  value="<?php echo $b['author']?>" type="text" name="author" id="author" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <select name="category_id" id="category_id" class="form-control">
                                    ...
                                    foreach ($cats as $c){
                                        ...
                                        ?>
                                        <option <?php if($b['category_id']==$c['id']){ echo "selected";} ?> value="<?php echo $c['id']?>"><?php echo $c['category_name']?> </option>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input  style="height: auto" type="file" name="cover" id="cover" class="form-control">
