...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm-6 col-sm-offset-3">
            <h3 class="text-center" style="color:white ;background: steelblue; line-height: 60px;border-radius: 40px;">Registration Session </h3>
           ...
           <div class="alert alert-danger" style="border-radius: 30px;text-decoration-color: white"><?php echo $_SESSION['err']?> </div>
            ...
            Do you already have an account ? <a href="signin.php"><span class="glyphicon glyphicon-log-in"> </span> Signin </a>
